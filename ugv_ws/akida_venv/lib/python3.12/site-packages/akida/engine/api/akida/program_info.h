...
class AKIDASHAREDLIB_EXPORT ProgramInfo {
 public:
  ...
  /**
   * @brief Return the input dimensions of the program as a 3D Shape
   */
  Shape input_dims() const;
  ...
  /**
   * @brief Return true if the program is for an anomaly detection model
   */
