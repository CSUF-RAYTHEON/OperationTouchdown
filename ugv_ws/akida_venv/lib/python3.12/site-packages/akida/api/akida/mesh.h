 ...
 */
inline constexpr SramSize SramSize_v1 = {.input_bytes = 43008,
                                         .weight_bytes = 44800};
 ...
 */
inline constexpr SramSize SramSize_v2 = {.input_bytes = 65536,
                                         .weight_bytes = 51200};

/**
 * The default SRAM size for Pico.
 */
inline constexpr SramSize SramSize_pico = {.stsram_32b_size = 448,
                                           .fsram_64b_size = 8192,
                                           .tsram_51b_size = 892,
                                           .evsram_32b_size = 256};
