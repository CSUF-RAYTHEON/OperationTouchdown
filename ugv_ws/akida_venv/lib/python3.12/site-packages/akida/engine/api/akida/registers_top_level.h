...
inline constexpr RegDetail REG_INTERRUPT_CONTROLLER_SOURCE_MASK_PICO_ANOMALY(
    12);
...
inline constexpr RegDetail REG_INTERRUPT_CONTROLLER_SOURCE_PICO_ANOMALY(12);

inline constexpr uint32_t REG_INTERRUPT_CONTROLLER_SOURCE_STATUS =
    INTERRUPT_CONTROLLER_OFFSET + 0xC;
inline constexpr RegDetail REG_INTERRUPT_CONTROLLER_SOURCE_STATUS_PICO_ANOMALY(
    12);

inline constexpr uint32_t REG_INTERRUPT_CONTROLLER_CLEAR_SOURCE_STATUS =
    INTERRUPT_CONTROLLER_OFFSET + 0x10;
inline constexpr RegDetail REG_INTERRUPT_CLEAR_PICO_ANOMALY(8);
...
namespace pico {
// STSRAM register
inline constexpr uint32_t STSRAM_REG = 0x70;
inline constexpr RegDetail STSRAM_SIZE(0, 31);

// FSRAM register
inline constexpr uint32_t FSRAM_REG = 0x74;
inline constexpr RegDetail FSRAM_SIZE(0, 31);

// TSRAM register
inline constexpr uint32_t TSRAM_REG = 0x78;
inline constexpr RegDetail TSRAM_SIZE(0, 31);

// EVSRAM register
inline constexpr uint32_t EVSRAM_REG = 0x7c;
inline constexpr RegDetail EVSRAM_SIZE(0, 31);
}  // namespace pico
