  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: features
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_depthai_ros_msgs__msg__TrackedFeature(
        &array_ptr[i], cdr);
    }
  }
  ...
  depthai_ros_msgs__msg__TrackedFeatures * ros_message)
{
  ...
  // Field name: features
  {
    ...
    auto array_ptr = ros_message->features.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_depthai_ros_msgs__msg__TrackedFeature(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: features
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_depthai_ros_msgs__msg__TrackedFeature(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: features
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_depthai_ros_msgs__msg__TrackedFeature(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: features
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_depthai_ros_msgs__msg__TrackedFeature(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const depthai_ros_msgs__msg__TrackedFeatures * ros_message = static_cast<const depthai_ros_msgs__msg__TrackedFeatures *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_depthai_ros_msgs__msg__TrackedFeatures(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  depthai_ros_msgs__msg__TrackedFeatures * ros_message = static_cast<depthai_ros_msgs__msg__TrackedFeatures *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_depthai_ros_msgs__msg__TrackedFeatures(cdr, ros_message);
}
