# This code tests changing parametes such that the drone uses GPS as its main positioning system
...
def use_gps(master):
    ...
    params = {"EK2_ENABLE": 0, "EK3_ENABLE": 1, "AHRS_EKF_TYPE": 3, "GPS1_TYPE": 1, "GPS_PRIMARY": 0, 
              "EK3_SRC1_POSXY": 3, "EK3_SRC1_VELXY": 3, "EK3_SRC1_POSZ": 1, "EK3_SRC1_VELZ": 0, "EK3_SRC1_YAW": 1}
