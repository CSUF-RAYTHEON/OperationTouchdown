    ...
    with Flash() as flash:
        if args.action == "erase":
            ...
            for i in range(args.count):
                ...
                address += increment
            print(f"Successfully erased {args.count * increment} bytes"
                  f" ({args.count} blocks of {args.block_size})")

        elif args.action == "write":
            flash.write(args.address, args.file.read())
            print(f"Successfully wrote '{args.file.name}' to flash at address 0x{args.address:08x}")
            ...
            if args.file is None:
                ...
                print(f"Successfully read {args.count} bytes from flash to '{args.file.name}'")
