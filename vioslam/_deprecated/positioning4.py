...
ORB_NFEATURES = 400 # number of ORB features to keep to use compare against old images. decreasing this means faster matching but more risk of missing a loop closure. 
ORB_SCALE = 0.5
