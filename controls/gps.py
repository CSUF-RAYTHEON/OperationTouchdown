# This code includes a utility function that changes parameters such that the drone uses GPS Navigation as its main positioning system.
# The testing code when run as main simply runs the utility function. The parameters are for ardupilot copter parameters from pymavlink import mavutil
from pymavlink import mavutil
from controls.connect import connect_UART0
from TestComponents.test_change_flight_mode import change_flight_mode

def use_gps(master):
    print(f"Entered use_gps() & Setting GPS Parameters for Target System: {master.target_system} & Target Component: {master.target_component}")

    # 1. Setting GPS parameters for the drone, these parameters dicate what the drone will use for GPS and positioning.
    ...
    params = {"EK2_ENABLE": 0, "EK3_ENABLE": 1, "AHRS_EKF_TYPE": 3, "GPS1_TYPE": 1, "GPS_PRIMARY": 0, 
              "EK3_SRC1_POSXY": 3, "EK3_SRC2_POSXY": 0, "EK3_SRC1_VELXY": 3, "EK3_SRC1_POSZ": 1, "EK3_SRC1_VELZ": 3, "EK3_SRC1_YAW": 1}
