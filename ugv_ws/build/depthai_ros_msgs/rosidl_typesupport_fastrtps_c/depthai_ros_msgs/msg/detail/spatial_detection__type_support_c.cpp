  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const depthai_ros_msgs__msg__SpatialDetection * ros_message = static_cast<const depthai_ros_msgs__msg__SpatialDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_depthai_ros_msgs__msg__SpatialDetection(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  depthai_ros_msgs__msg__SpatialDetection * ros_message = static_cast<depthai_ros_msgs__msg__SpatialDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_depthai_ros_msgs__msg__SpatialDetection(cdr, ros_message);
}
