...
struct MemoryInfo {
  ...
  // Stram Pico memory size. (Number of 32-bits words)
  uint32_t stsram_32b_size{};
  // Fsram Pico memory size. (Number of 64-bits words)
  uint32_t fsram_64b_size{};
  // Tsram Pico memory size. (Number of 51-bits words)
  uint32_t tsram_51b_size{};
  // Evsram Pico memory size. (Number of 32-bits words)
