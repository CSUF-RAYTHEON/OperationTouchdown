...
Shape ProgramInfo::input_dims() const {
  const auto& input_dims = *program_info_->input_dims();
...
bool ProgramInfo::anomaly_detection() const {
  return program_info_->anomaly_detection();
}
}  // namespace akida
