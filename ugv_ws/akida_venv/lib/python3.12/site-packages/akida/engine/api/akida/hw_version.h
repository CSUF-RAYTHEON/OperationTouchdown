...
struct AKIDASHAREDLIB_EXPORT HwVersion {
  inline static constexpr uint8_t brn_id = 0xBC;
  uint8_t vendor_id;
  uint8_t product_id;
  uint8_t major_rev;
  uint8_t minor_rev;
...
inline constexpr HwVersion NSoC_v1 = {HwVersion::brn_id, 0, 0, 1};
inline constexpr HwVersion NSoC_v2 = {HwVersion::brn_id, 0, 0, 2};
inline constexpr HwVersion TwoNodesIP_v1 = {HwVersion::brn_id, 0xA1, 3, 6};
inline constexpr HwVersion AKD1500_v1 = {HwVersion::brn_id, 0xA1, 3, 9};
inline constexpr HwVersion FPGA_v2 = {HwVersion::brn_id, 0xA2, 1, 0};
inline constexpr HwVersion Pico_FPGA = {HwVersion::brn_id, 0xB1, 1, 0};
