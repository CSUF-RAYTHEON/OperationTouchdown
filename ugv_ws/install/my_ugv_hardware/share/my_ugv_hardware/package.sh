...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/home/ugv/Desktop/OperationTouchdown/ugv_ws/install/my_ugv_hardware"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/my_ugv_hardware/hook/path.sh"
