...
def test_viewer(camera_frame_mutex, attitude_mutex):
    W, H = 640, 400
...
if __name__ == "__main__":
    ...
    viewer_process = mp.Process(target=test_viewer, args=(camera_frame_mutex, attitude_mutex))
