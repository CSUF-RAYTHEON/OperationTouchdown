...
# we calculate our custom local positioning and store the value in a global variable. 

from pymavlink import mavutil
import global_variables
import time

def test_local_position_origin(master):
    print(f"Entered test_local_position_origin() for Target System: {master.target_system} & Target Component: {master.target_component}")
    ...
    print(f"Final drone origin values: x: {global_variables.origin_drone_x}, y: {global_variables.origin_drone_y}, z: {global_variables.origin_drone_z}")
    print(f"Final drone current position values: x: {global_variables.current_position_drone_x}, y: {global_variables.current_position_drone_y}, z: {global_variables.current_position_drone_z}")
    print(f"Final custom current position values: x: {global_variables.current_position_custom_x}, y: {global_variables.current_position_custom_y}, z: {global_variables.current_position_custom_z}")
...
if __name__ == "__main__":
    ...
    test_local_position_origin(master)