...
def build_master(akida: bool = False, nav2: bool = False) -> LaunchDescription:
    ...
    foxglove_bridge = IncludeLaunchDescription(
        ...
        launch_arguments={
            "topic_whitelist": "[\"/tf\", \"/tf_static\", \"/scan\", \"/odom\", \"/odometry/filtered\", \"/map\", \"/mission/state\", \"/local_costmap/costmap\", \"/global_costmap/costmap\", \"/akida/detected_objects\", \"/akida/inference_latency_ms\", \"/akida/image_annotated\", \"/diagnostics\", \"/lora/raw\", \"/robot_description\", \"/joint_states\", \"/clock\", \"/oak/rgb/camera_info\", \"/oak/stereo/camera_info\"]",
